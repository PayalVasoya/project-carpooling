    ...
    <div class="card-body">
      ...
      <form method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="brand_nm" placeholder="Brand name">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-12">
            <input type="submit" class="btn btn-primary btn-block" name="add_brand" value="Add Brand">
          </div>
          <!-- /.col -->
        </div>
      </form>

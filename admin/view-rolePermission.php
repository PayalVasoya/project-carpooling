<?php
  ...
  $sql = "SELECT rp.role_id, r.role_name, rp.permission_id, p.permission_name
...
<head>
  ...
  <title>AutoRoute | View-Roles Permission</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View Role and Permission</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
